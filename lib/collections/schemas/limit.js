...
if (Meteor.isClient) {
  Schemas.Limit.labels({
    sampleResponsibleId:      function () { return TAPi18n.__('limit_') },
    fieldDate:                function () { return TAPi18n.__('limit_') },
    sampleName:               function () { return TAPi18n.__('limit_') },
    work:                     function () { return TAPi18n.__('limit_') },
