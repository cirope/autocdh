MaintenancesController = RouteController.extend({
  ...
  findOptions: function () {
    return { sort: { active: -1, date: -1 }, limit: this.maintenancesLimit() }
  },

  subscriptions: function () {
    this.maintenancesSub = this.subscribe('maintenancesLimited', this.findOptions())
  },
...
MaintenanceMasterListController = RouteController.extend({
  data: function () {
    return {
      maintenances: Maintenances.find({ active: true })
    }
  }
})
