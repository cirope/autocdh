...
if (Meteor.isClient) {
  Schemas.FieldGranulometry.labels({
    sampleResponsibleId:      function () { return TAPi18n.__('field_granulometry_') },
    fieldDate:                function () { return TAPi18n.__('field_granulometry_') },
    sampleName:               function () { return TAPi18n.__('field_granulometry_') },
    work:                     function () { return TAPi18n.__('field_granulometry_') },
