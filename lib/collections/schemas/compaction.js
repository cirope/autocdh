...
if (Meteor.isClient) {
  Schemas.Compaction.labels({
    sampleResponsibleId:      function () { return TAPi18n.__('compaction_') },
    fieldDate:                function () { return TAPi18n.__('compaction_') },
    sampleName:               function () { return TAPi18n.__('compaction_') },
    work:                     function () { return TAPi18n.__('compaction_') },
