Schemas.Nonconformity = new SimpleSchema([Schemas.Base, {
    ...
    'solution.$.type': {
        ...
        autoform: {
            ...
            options: function () {
                return [
                    { value: 'corrective', label: TAPi18n.__('nonconformity_solution_type_corrective') },
                    { value: 'preventive',       label: TAPi18n.__('nonconformity_solution_type_preventive') },
                    { value: 'evolutionary',  label: TAPi18n.__('nonconformity_solution_type_evolutionary') }
                ]
            }
        }
    },
...
if (Meteor.isClient) {
    Schemas.Nonconformity.labels({
        ...
        solution:                 function () { return TAPi18n.__('nonconformity_solution') },
        'solution.$.number':      function () { return TAPi18n.__('nonconformity_solution_number') },
        'solution.$.type':        function () { return TAPi18n.__('nonconformity_solution_type') },
        'solution.$.description': function () { return TAPi18n.__('nonconformity_solution_desc') },
        'solution.$.date':        function () { return TAPi18n.__('nonconformity_solution_date') },
        'solution.$.responsibles':      function () { return TAPi18n.__('nonconformity_solution_resp') },
        'solution.$.responsibles.$.id': function () { return TAPi18n.__('nonconformity_solution_resp_id') },
