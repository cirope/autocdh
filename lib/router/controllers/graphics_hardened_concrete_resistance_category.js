...
var hardenedConcreteCategoryData = function () {
  ...
  var selector     = { crackedIn: { $ne: null }, stress: { $ne: null } }
  if (filter.discardLess28Days === 'true'){
    selector.days = { $gte: 28 };
  }

  var crackSelector   = castQuery(filter, sampleIds, selector)
