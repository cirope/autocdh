Schemas.Limit = new SimpleSchema([Schemas.Base, {
    ...
    liquid_empty_mass_p1: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('liquid_empty_mass_p2').value) {
                    return 'notUnique'
                }
                if(this.value == this.field('liquid_empty_mass_p3').value) {
                    return 'notUnique'
                }
            }
        }
    ...
    liquid_wet_mass_p1: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('liquid_wet_mass_p2').value) {
                    return 'notUnique'
                }
                if(this.value == this.field('liquid_wet_mass_p3').value) {
                    return 'notUnique'
                }
            }
        }
    ...
    liquid_dry_mass_p1: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('liquid_dry_mass_p2').value) {
                    return 'notUnique'
                }
                if(this.value == this.field('liquid_dry_mass_p3').value) {
                    return 'notUnique'
                }
            }
        }
    ...
    liquid_empty_mass_p2: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('liquid_empty_mass_p1').value) {
                    return 'notUnique'
                }
                if(this.value == this.field('liquid_empty_mass_p3').value) {
                    return 'notUnique'
    ...
    liquid_wet_mass_p2: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('liquid_wet_mass_p1').value) {
                    return 'notUnique'
                }
                if(this.value == this.field('liquid_wet_mass_p3').value) {
                    return 'notUnique'
    ...
    liquid_dry_mass_p2: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('liquid_dry_mass_p1').value) {
                    return 'notUnique'
                }
                if(this.value == this.field('liquid_dry_mass_p3').value) {
                    return 'notUnique'
    ...
    plastic_empty_mass_d1: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('plastic_empty_mass_d2').value) {
                    return 'notUnique'
                }
            }
        }
    ...
    plastic_wet_mass_d1: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('plastic_wet_mass_d2').value) {
                    return 'notUnique'
                }
            }
        }
    ...
    plastic_dry_mass_d1: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('plastic_dry_mass_d2').value) {
                    return 'notUnique'
                }
            }
        }
    ...
    plastic_empty_mass_d2: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('plastic_empty_mass_d1').value) {
                    return 'notUnique'
                }
            }
        }
    ...
    plastic_wet_mass_d2: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('plastic_wet_mass_d1').value) {
                    return 'notUnique'
                }
            }
        }
    ...
    plastic_dry_mass_d2: {
        ...
        custom: function () {
            if (this.isSet) {
                if(this.value == this.field('plastic_dry_mass_d1').value) {
                    return 'notUnique'
                }
            }
        }
