Template.granulometryHumidities.helpers({
  showList: function () {
    return this.granulometryHumidities.count() || this.hasQuery
  }
})

Template.granulometryHumiditiesList.helpers({
...
Template.granulometryHumiditiesList.events({
  'click [data-action="search"]': function (event, template) {
    ...
    Router.go('granulometryHumidities', {}, { query: search })
  },
