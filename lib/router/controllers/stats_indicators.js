...
StatsIndicatorsDashboardController = RouteController.extend({
  data: function () {
    var start     = moment().subtract(1, 'year').startOf('day')
    ...
    strengths.forEach(function (strength) {
      ...
      cracksByStrength[strength.name] = _.sortBy(_.compact(_cracks), function (crack) {
