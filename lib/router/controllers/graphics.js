...
var hardenedConcreteData = function () {
  ...
  if (filterSamples(filter).count()) {
    ...
    if (strength.individualCriteria && strength.averageCriteria) {
      var upperLimit  = arrayOf(strength.individualCriteria, labels.length)
      var lowerLimit  = arrayOf(strength.averageCriteria, labels.length)
