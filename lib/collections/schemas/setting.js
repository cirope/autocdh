...
if (Meteor.isClient) {
  Schemas.Setting.labels({
    ...
    'digitalSignature.pdfFreshConcrete':             function () { return TAPi18n.__('setting_pdf_fresh_concrete') },
    'digitalSignature.pdfHardenedConcrete':          function () { return TAPi18n.__('setting_pdf_hardened_concrete') },
    'digitalSignature.pdfStatsAggregates':           function () { return TAPi18n.__('setting_pdf_stats_aggregates') },
    'digitalSignature.pdfStatsIndicators':           function () { return TAPi18n.__('setting_pdf_stats_indicators') },
