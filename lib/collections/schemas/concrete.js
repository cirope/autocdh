Schemas.Concrete = new SimpleSchema([Schemas.Base, {
  ...
  downloadId: {
    ...
    autoform: {
      afFieldInput: {
        options: function () {
          var downloads = Downloads.find({}, { sort: { name: 1 } }).map(function (download) {
  ...
  aggregateId: {
    ...
    autoform: {
      ...
      afFieldInput: {
        options: function () {
          var aggregates = Aggregates.find({}, { sort: { name: 1 } }).map(function (aggregate) {
  ...
  settlementId: {
    ...
    autoform: {
      ...
      afFieldInput: {
        options: function () {
          var settlements = Settlements.find({}, { sort: { name: 1 } }).map(function (settlement) {
