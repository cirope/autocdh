...
Template.graphicFreshConcreteTemperature.events({
  'click [data-download-pdf]': function (event, template) {
    PdfHelper.generateGraphPage(template, 'data-container', 'graphic_fresh_concrete_temperature', 'pdfFreshConcrete', putFilterData)
  }
})
